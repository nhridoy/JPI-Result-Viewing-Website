<?php
	...
	if(isset($_POST['submit'])){
		...
		if($error==0){
			$object = new connect;
			$insert="INSERT into tct1st VALUES('','$roll','$month','$year','$tc69411','$tf69411','$pc69411','$pf69411','$tc66712','$tf66712','$pc66712','$pf66712','$tc65911','$tf65911','$pc65911','$tc65913','$tf65913','$pc65913','$pf65913','$tc65811','$tf65811','$pc65812','$pf65812')";
					...
					<div class="roll">
	          		...
	          		<div class="subjects">
	          			...
	          			<div class="subjects_marks">
	          				<ul>
	          					<li><input type="text" name="69411tc" placeholder="69411 TC"><input type="text" name="69411tf" placeholder="69411 TF"><input type="text" name="69411pc" placeholder="69411 PC"><input type="text" name="69411pf" placeholder="69411 PF"></li>
