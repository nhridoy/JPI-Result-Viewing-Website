<?php
	...
	if(isset($_POST['submit'])){
		...
		if($error==0){
			$object = new connect;
			$insert="INSERT into c1st VALUES('','$roll','$month','$year','$pc61011','$pf61011','$tc65711','$tf65711','$pc65711','$tc65712','$tf65712','$tc65911','$tf65911','$pc65911','$tc66712','$tf66712','$pc66712','$pf66712','$tc65912','$tf65912','$pc65912','$pf65912','$pc67012','$pf67012')";
	          		...
	          		<div class="subjects">
	          			...
	          			<div class="subjects_marks">
	          				<ul>
	          					...
	          					<li><input type="text" name="67012tc" placeholder="disabled" disabled=""><input type="text" name="67012tf" placeholder="disabled" disabled=""><input type="text" name="67012pc" placeholder="67012 PC"><input type="text" name="67012pf" placeholder="67012 PF"></li>
	          				</ul>
	          			</div>
	          		</div>
