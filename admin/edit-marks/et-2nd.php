<?php
	...
	$marks = "SELECT * FROM et2nd WHERE roll='$roll'";
	$select_marks = $object->marks($marks);
	/*while($select_loop=$select_result->fetch_object()){
		echo $select_loop->user_name;
	}*/
	$marks_loop=$select_marks->fetch_object();
	$markstc66721 = $marks_loop->tc66721; 
	$markstf66721 = $marks_loop->tf66721; 
	$markspc66721 = $marks_loop->pc66721; 
	$markspf66721 = $marks_loop->pf66721; 
	$markstc66722 = $marks_loop->tc66722; 
	$markstf66722 = $marks_loop->tf66722; 
	$markspc66722 = $marks_loop->pc66722; 
	$markspf66722 = $marks_loop->pf66722; 
	...
	if($markstc66721 >= (60*40)/100 && $markstf66721 >= (90*40)/100 && $markspc66721 >= (25*40)/100 && $markspf66721 >= (25*40)/100){
		$marks66721=$markstc66721 + $markstf66721 + $markspc66721 + $markspf66721;
	}else{
		$marks66721 = 0;
	}
	if($markstc66722 >= (40*40)/100 && $markstf66722 >= (60*40)/100 && $markspc66722 >= (25*40)/100 && $markspf66722 >= (25*40)/100){
		$marks66722=$markstc66722 + $markstf66722 + $markspc66722 + $markspf66722;
	}else{
		$marks66722 = 0;
	}
	...
	if($marks66721 >= (200*80)/100){
		$gpa66721 = "A+";
		$grade66721 = "4.00";
	}
	elseif($marks66721 >= (200*75)/100 && $marks66721 < (200*80)/100){
		$gpa66721 = "A";
		$grade66721 = "3.75";
	}
	elseif($marks66721 >= (200*70)/100 && $marks66721 < (200*75)/100){
		$gpa66721 = "A-";
		$grade66721 = "3.50";
	}
	elseif($marks66721 >= (200*65)/100 && $marks66721 < (200*70)/100){
		$gpa66721 = "B+";
		$grade66721 = "3.25";
	}
	elseif($marks66721 >= (200*60)/100 && $marks66721 < (200*65)/100){
		$gpa66721 = "B";
		$grade66721 = "3.00";
	}
	elseif($marks66721 >= (200*55)/100 && $marks66721 < (200*60)/100){
		$gpa66721 = "B-";
		$grade66721 = "2.75";
	}
	elseif($marks66721 >= (200*50)/100 && $marks66721 < (200*55)/100){
		$gpa66721 = "C+";
		$grade66721 = "2.50";
	}
	elseif($marks66721 >= (200*45)/100 && $marks66721 < (200*50)/100){
		$gpa66721 = "C";
		$grade66721 = "2.25";
	}
	elseif($marks66721 >= (200*40)/100 && $marks66721 < (200*45)/100){
		$gpa66721 = "D";
		$grade66721 = "2.00";
	}
	elseif($marks66721 < (200*40)/100){
		$gpa66721 = "F";
		$grade66721 = "0.00";
	}
	...
	if($marks66722 >= (150*80)/100){
		$gpa66722 = "A+";
		$grade66722 = "4.00";
	}
	elseif($marks66722 >= (150*75)/100 && $marks66722 < (150*80)/100){
		$gpa66722 = "A";
		$grade66722 = "3.75";
	}
	elseif($marks66722 >= (150*70)/100 && $marks66722 < (150*75)/100){
		$gpa66722 = "A-";
		$grade66722 = "3.50";
	}
	elseif($marks66722 >= (150*65)/100 && $marks66722 < (150*70)/100){
		$gpa66722 = "B+";
		$grade66722 = "3.25";
	}
	elseif($marks66722 >= (150*60)/100 && $marks66722 < (150*65)/100){
		$gpa66722 = "B";
		$grade66722 = "3.00";
	}
	elseif($marks66722 >= (150*55)/100 && $marks66722 < (150*60)/100){
		$gpa66722 = "B-";
		$grade66722 = "2.75";
	}
	elseif($marks66722 >= (150*50)/100 && $marks66722 < (150*55)/100){
		$gpa66722 = "C+";
		$grade66722 = "2.50";
	}
	elseif($marks66722 >= (150*45)/100 && $marks66722 < (150*50)/100){
		$gpa66722 = "C";
		$grade66722 = "2.25";
	}
	elseif($marks66722 >= (150*40)/100 && $marks66722 < (150*45)/100){
		$gpa66722 = "D";
		$grade66722 = "2.00";
	}
	elseif($marks66722 < (150*40)/100){
		$gpa66722 = "F";
		$grade66722 = "0.00";
	}
	...
	if($grade66721>0 && $grade66722>0 && $grade65711>0 && $grade65712>0 && $grade65921>0 && $grade65912>0 && $grade66611>0){
		$grade = ($grade66721+$grade66722 +$grade65711+$grade65712 +$grade65921 +$grade65912 +$grade66611)/7 .".00";
...
<head>
	<meta charset="UTF-8">
	<title>Electrical 2nd Semester Result</title>
...
<body>
  ...
  ?>)</p>
		...
		<div class="result">
			<center>
				<table cellspacing="0">
					...
					<tr>
						<td>66721 - Electrical Circuits-1</td>
						<td>4</td>
						<td><?php echo $marks66721; ?></td>
						<td><?php echo $gpa66721; ?></td>
						<td><?php echo $grade66721; ?></td>
					</tr>
					<tr>
						<td>66722 - Electrical Appliance</td>
						<td>3</td>
						<td><?php echo $marks66722; ?></td>
						<td><?php echo $gpa66722; ?></td>
						<td><?php echo $grade66722; ?></td>
					</tr>
					<tr>
						<td>65711 - Bangla</td>
						<td>4</td>
		...
		<div class="footer"><center>
			<a style="display: inline-block;color: #fff;background: red;padding: 5px 10px;" href="et/et2nd.php?edit=<?php echo $select_loop->roll; ?>">Edit</a>
