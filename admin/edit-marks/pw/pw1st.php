<?php
	...
	$object=new connect;
	$roll= $_GET['edit'];
	$select = "SELECT * FROM pw1st WHERE roll='$roll'";
	...
	if(isset($_POST['submit'])){
		...
		*/
		...
		if($error==0){
			$update = "UPDATE pw1st SET tc67111='$tc67111',tf67111='$tf67111',pc67111='$pc67111',pf67111='$pf67111',pc61011='$pc61011',pf61011='$pf61011',tc65911='$tc65911',tf65911='$tf65911',pc65911='$pc65911',tc65912='$tc65912',tf65912='$tf65912',pc65912='$pc65912',pf65912='$pf65912',tc65712='$tc65712',tf65712='$tf65712',tc65711='$tc65711',tf65711='$tf65711',pc65711='$pc65711' WHERE roll='$roll'";
					...
					<div class="roll">
	          		...
	          		<div class="subjects">
	          			...
	          			<div class="subjects_marks">
	          				<ul>
	          					<li><input type="text" name="67111tc" value="<?php echo $select_loop->tc67111; ?>"><input type="text" name="67111tf" value="<?php echo $select_loop->tf67111; ?>"><input type="text" name="67111pc" value="<?php echo $select_loop->pc67111; ?>"><input type="text" name="67111pf" value="<?php echo $select_loop->pf67111; ?>"></li>
