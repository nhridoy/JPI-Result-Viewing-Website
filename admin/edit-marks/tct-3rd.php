<?php
	...
	$marks = "SELECT * FROM tct3rd WHERE roll='$roll'";
	$select_marks = $object->marks($marks);
	/*while($select_loop=$select_result->fetch_object()){
		echo $select_loop->user_name;
	}*/
	$marks_loop=$select_marks->fetch_object();
	$markstc69431 = $marks_loop->tc69431; 
	$markstf69431 = $marks_loop->tf69431; 
	$markspc69431 = $marks_loop->pc69431; 
	$markspf69431 = $marks_loop->pf69431; 
	$markstc69432 = $marks_loop->tc69432; 
	$markstf69432 = $marks_loop->tf69432; 
	$markspc69432 = $marks_loop->pc69432; 
	$markspf69432 = $marks_loop->pf69432; 
	$markspc66621 = $marks_loop->pc66621; 
	$markspf66621 = $marks_loop->pf66621; 
	$markstc66823 = $marks_loop->tc66823; 
	$markstf66823 = $marks_loop->tf66823; 
	$markspc66823 = $marks_loop->pc66823; 
	$markspf66823 = $marks_loop->pf66823; 
	...
	if($markstc69431 >= (20*40)/100 && $markstf69431 >= (30*40)/100 && $markspc69431 >= (25*40)/100 && $markspf69431 >= (25*40)/100){
		$marks69431=$markstc69431 + $markstf69431 + $markspc69431 + $markspf69431;
	}else{
		$marks69431 = 0;
	}
	if($markstc69432 >= (20*40)/100 && $markstf69432 >= (30*40)/100 && $markspc69432 >= (25*40)/100 && $markspf69432 >= (25*40)/100){
		$marks69432=$markstc69432 + $markstf69432 + $markspc69432 + $markspf69432;
	}else{
		$marks69432 = 0;
	}
	...
	if($markstc66823 >= (60*40)/100 && $markstf66823 >= (90*40)/100 && $markspc66823 >= (25*40)/100 && $markspf66823 >= (25*40)/100){
		$marks66823=$markstc66823 + $markstf66823 + $markspc66823 + $markspf66823;
	}else{
		$marks66823 = 0;
	}
	...
	if($marks69431 >= (100*80)/100){
		$gpa69431 = "A+";
		$grade69431 = "4.00";
	}
	elseif($marks69431 >= (100*75)/100 && $marks69431 < (100*80)/100){
		$gpa69431 = "A";
		$grade69431 = "3.75";
	}
	elseif($marks69431 >= (100*70)/100 && $marks69431 < (100*75)/100){
		$gpa69431 = "A-";
		$grade69431 = "3.50";
	}
	elseif($marks69431 >= (100*65)/100 && $marks69431 < (100*70)/100){
		$gpa69431 = "B+";
		$grade69431 = "3.25";
	}
	elseif($marks69431 >= (100*60)/100 && $marks69431 < (100*65)/100){
		$gpa69431 = "B";
		$grade69431 = "3.00";
	}
	elseif($marks69431 >= (100*55)/100 && $marks69431 < (100*60)/100){
		$gpa69431 = "B-";
		$grade69431 = "2.75";
	}
	elseif($marks69431 >= (100*50)/100 && $marks69431 < (100*55)/100){
		$gpa69431 = "C+";
		$grade69431 = "2.50";
	}
	elseif($marks69431 >= (100*45)/100 && $marks69431 < (100*50)/100){
		$gpa69431 = "C";
		$grade69431 = "2.25";
	}
	elseif($marks69431 >= (100*40)/100 && $marks69431 < (100*45)/100){
		$gpa69431 = "D";
		$grade69431 = "2.00";
	}
	elseif($marks69431 < (100*40)/100){
		$gpa69431 = "F";
		$grade69431 = "0.00";
	}
	...
	if($marks69432 >= (100*80)/100){
		$gpa69432 = "A+";
		$grade69432 = "4.00";
	}
	elseif($marks69432 >= (100*75)/100 && $marks69432 < (100*80)/100){
		$gpa69432 = "A";
		$grade69432 = "3.75";
	}
	elseif($marks69432 >= (100*70)/100 && $marks69432 < (100*75)/100){
		$gpa69432 = "A-";
		$grade69432 = "3.50";
	}
	elseif($marks69432 >= (100*65)/100 && $marks69432 < (100*70)/100){
		$gpa69432 = "B+";
		$grade69432 = "3.25";
	}
	elseif($marks69432 >= (100*60)/100 && $marks69432 < (100*65)/100){
		$gpa69432 = "B";
		$grade69432 = "3.00";
	}
	elseif($marks69432 >= (100*55)/100 && $marks69432 < (100*60)/100){
		$gpa69432 = "B-";
		$grade69432 = "2.75";
	}
	elseif($marks69432 >= (100*50)/100 && $marks69432 < (100*55)/100){
		$gpa69432 = "C+";
		$grade69432 = "2.50";
	}
	elseif($marks69432 >= (100*45)/100 && $marks69432 < (100*50)/100){
		$gpa69432 = "C";
		$grade69432 = "2.25";
	}
	elseif($marks69432 >= (100*40)/100 && $marks69432 < (100*45)/100){
		$gpa69432 = "D";
		$grade69432 = "2.00";
	}
	elseif($marks69432 < (100*40)/100){
		$gpa69432 = "F";
		$grade69432 = "0.00";
	}
	...
	if($marks66823 >= (200*80)/100){
		$gpa66823 = "A+";
		$grade66823 = "4.00";
	}
	elseif($marks66823 >= (20075)/100 && $marks66823 < (200*80)/100){
		$gpa66823 = "A";
		$grade66823 = "3.75";
	}
	elseif($marks66823 >= (200*70)/100 && $marks66823 < (200*75)/100){
		$gpa66823 = "A-";
		$grade66823 = "3.50";
	}
	elseif($marks66823 >= (200*65)/100 && $marks66823 < (200*70)/100){
		$gpa66823 = "B+";
		$grade66823 = "3.25";
	}
	elseif($marks66823 >= (200*60)/100 && $marks66823 < (200*65)/100){
		$gpa66823 = "B";
		$grade66823 = "3.00";
	}
	elseif($marks66823 >= (200*55)/100 && $marks66823 < (200*60)/100){
		$gpa66823 = "B-";
		$grade66823 = "2.75";
	}
	elseif($marks66823 >= (200*50)/100 && $marks66823 < (200*55)/100){
		$gpa66823 = "C+";
		$grade66823 = "2.50";
	}
	elseif($marks66823 >= (200*45)/100 && $marks66823 < (200*50)/100){
		$gpa66823 = "C";
		$grade66823 = "2.25";
	}
	elseif($marks66823 >= (200*40)/100 && $marks66823 < (200*45)/100){
		$gpa66823 = "D";
		$grade66823 = "2.00";
	}
	elseif($marks66823 < (200*40)/100){
		$gpa66823 = "F";
		$grade66823 = "0.00";
	}
	...
	if($grade69431>0 && $grade69432>0 && $grade66621>0 && $grade66823>0 && $grade65931>0 && $grade65922>0 && $grade65722>0){
		$grade = ($grade69431+$grade69432 +$grade66621+$grade66823 +$grade65931 +$grade65922 +$grade65722)/7 .".00";
...
<head>
	<meta charset="UTF-8">
	<title>Telecommunication 3rd Semester Result</title>
...
<body>
  ...
  ?>)</p>
		...
		<div class="result">
			<center>
				<table cellspacing="0">
					...
					<tr>
						<td>69431 - Telecom Workshop Practice</td>
						<td>2</td>
						<td><?php echo $marks69431; ?></td>
						<td><?php echo $gpa69431; ?></td>
						<td><?php echo $grade69431; ?></td>
					</tr>
					<tr>
						<td>69432 - Outside Plant</td>
						<td>2</td>
						<td><?php echo $marks69432; ?></td>
						<td><?php echo $gpa69432; ?></td>
						<td><?php echo $grade69432; ?></td>
					</tr>
					<tr>
					...
					<tr>
						<td>66823 - Analog Electronics</td>
						<td>4</td>
						<td><?php echo $marks66823; ?></td>
						<td><?php echo $gpa66823; ?></td>
						<td><?php echo $grade66823; ?></td>
					</tr>
					<tr>
		...
		<div class="footer"><center>
			<a style="display: inline-block;color: #fff;background: red;padding: 5px 10px;" href="tct/tct3rd.php?edit=<?php echo $select_loop->roll; ?>">Edit</a>
