<?php
	...
	$marks = "SELECT * FROM tct1st WHERE roll='$roll'";
	$select_marks = $object->marks($marks);
	/*while($select_loop=$select_result->fetch_object()){
		echo $select_loop->user_name;
	}*/
	$marks_loop=$select_marks->fetch_object();
	$markstc69411 = $marks_loop->tc69411; 
	$markstf69411 = $marks_loop->tf69411; 
	$markspc69411 = $marks_loop->pc69411; 
	$markspf69411 = $marks_loop->pf69411; 
	...
	if($markstc69411 >= (60*40)/100 && $markstf69411 >= (90*40)/100 && $markspc69411 >= (25*40)/100 && $markspf69411 >= (25*40)/100){
		$marks69411=$markstc69411 + $markstf69411 + $markspc69411 + $markspf69411;
	}else{
		$marks69411 = 0;
	}
	...
	if($marks69411 >= (200*80)/100){
		$gpa69411 = "A+";
		$grade69411 = "4.00";
	}
	elseif($marks69411 >= (20075)/100 && $marks69411 < (200*80)/100){
		$gpa69411 = "A";
		$grade69411 = "3.75";
	}
	elseif($marks69411 >= (200*70)/100 && $marks69411 < (200*75)/100){
		$gpa69411 = "A-";
		$grade69411 = "3.50";
	}
	elseif($marks69411 >= (200*65)/100 && $marks69411 < (200*70)/100){
		$gpa69411 = "B+";
		$grade69411 = "3.25";
	}
	elseif($marks69411 >= (200*60)/100 && $marks69411 < (200*65)/100){
		$gpa69411 = "B";
		$grade69411 = "3.00";
	}
	elseif($marks69411 >= (200*55)/100 && $marks69411 < (200*60)/100){
		$gpa69411 = "B-";
		$grade69411 = "2.75";
	}
	elseif($marks69411 >= (200*50)/100 && $marks69411 < (200*55)/100){
		$gpa69411 = "C+";
		$grade69411 = "2.50";
	}
	elseif($marks69411 >= (200*45)/100 && $marks69411 < (200*50)/100){
		$gpa69411 = "C";
		$grade69411 = "2.25";
	}
	elseif($marks69411 >= (200*40)/100 && $marks69411 < (200*45)/100){
		$gpa69411 = "D";
		$grade69411 = "2.00";
	}
	elseif($marks69411 < (200*40)/100){
		$gpa69411 = "F";
		$grade69411 = "0.00";
	}
	...
	if($grade69411>0 && $grade66712>0 && $grade65911>0 && $grade65913>0 && $grade65811>0 && $grade65812>0){
		$grade = ($grade69411+$grade66712 +$grade65911+$grade65913 +$grade65811 +$grade65812)/6 .".00";
...
<head>
	<meta charset="UTF-8">
	<title>Telecommunication 1st Semester Result</title>
...
<body>
  ...
  ?>)</p>
		...
		<div class="result">
			<center>
				<table cellspacing="0">
					...
					<tr>
						<td>69411 - Telecommunication System Basics</td>
						<td>4</td>
						<td><?php echo $marks69411; ?></td>
						<td><?php echo $gpa69411; ?></td>
						<td><?php echo $grade69411; ?></td>
					</tr>
					<tr>
		...
		<div class="footer"><center>
			<a style="display: inline-block;color: #fff;background: red;padding: 5px 10px;" href="tct/tct1st.php?edit=<?php echo $select_loop->roll; ?>">Edit</a>
